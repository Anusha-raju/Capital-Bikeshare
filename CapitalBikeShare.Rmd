...
Member_casual_tree <- rpart(member_casual~ rideable_type + distance_miles + ride_duration_mins + start_time_period, data = capital_bikeshare_clean, method = "class")
...
treefit_fold <- rpart(member_casual~ rideable_type + distance_miles + ride_duration_mins + start_time_period, data = capital_bikeshare_clean, method = "class")
