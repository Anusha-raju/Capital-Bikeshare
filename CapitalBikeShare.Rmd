...
All models are statistically significant. Models 8, and 9 the lowest residual deviance, but introduce significant complexity indicated by the extremely high degrees of freedom, likely overfitting. Models 6 and 7 both show a substantive improvement in deviance, though 6 has higher deviance reduction for fewer degrees of freedom. Model 6 is likely best fit for balance between fit and complexity. However the VIF for model 6 shows that all of the interation terms are collinear. Model 4 is likely the best choce given a statistically significant reduction in deviance and the VIF for Model 4 allows 4 variables that that show complete independence from each other. 
